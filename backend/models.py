...
class CreateUser(BaseUserManager):
    """
    Метод для создания пользователя с заданным электронным адресом,
    паролем и дополнительными полями.
    """
...
class User(AbstractUser):
    ...
    type = models.CharField(verbose_name='Тип пользователя', choices=USER_TYPES, max_length=6, default='buyer')
...
class Shop(models.Model):
    ...
    seller = models.OneToOneField(User, verbose_name='Продавец', blank=True, null=True, on_delete=models.CASCADE)
...
class ProductParameter(models.Model):
    """
    Модель связи продукта и параметра
    """
...
class Order(models.Model):
    ...
    user_contact = models.ForeignKey(Contact, verbose_name='Контакт', blank=True, null=True, on_delete=models.CASCADE)
